...
void HariMain(void)
{
    ...
    logox = (binfo->scrnx - strlen(logo) * 8 * pixle_size) / 2;
    logoy = (binfo->scrny - 30 - 16 * pixle_size) / 2;
    show_logo8(binfo->vram, binfo->scrnx, logox, logoy, WHITE, LIGHT_DARK_BLUE, logo, pixle_size);
